    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" className={styles.textLink}>Github</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://github.com/olejnikoves3" className={styles.textLink}>Олейников Евгений</a>
            </p>
          </div>
        </aside>
      </div>
